			...
			OneSignal.push(function() {
				...
				OneSignal.init({
					...
					promptOptions: {
						...
						siteName: 'Maisbaratoaqui',
						/* Subtitle, limited to 90 characters */
						actionMessage: "Receba atualizações em tempo real e não perca nenhuma novidade! Permita notificações agora.",
						/* Example notification title */
						exampleNotificationTitle: 'Maisbaratoaqui',
						/* Text below example notification, limited to 50 characters */
						exampleNotificationCaption: 'Você pode cancelar a assinatura a qualquer momento',
						/* Accept button text, limited to 15 characters */
						acceptButtonText: "ACEITAR",
						/* Cancel button text, limited to 15 characters */
						cancelButtonText: "NÃO",
						autoAcceptTitle: 'Clique em aceitar'
					}
				});
